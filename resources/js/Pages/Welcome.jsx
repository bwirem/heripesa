...
import { faHandHoldingUsd, faUsers, faRocket } from '@fortawesome/free-solid-svg-icons'; // Updated icons
...
export default function WelcomeSupport({ auth }) {
    ...
    return (
        <>
            <Head title="Welcome to HeriPesa" />
                ...
                <div className="relative z-20 w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header className="grid grid-cols-1 md:grid-cols-3 items-center gap-4 py-10 text-center md:text-left">
                        ...
                        <div className="md:col-start-2 flex flex-col items-center">
                            <h1 className={`text-4xl md:text-5xl font-bold text-${primaryColor}`}>HeriPesa</h1> {/* Use the primary color */}
                        </div>
                        ...
                        <div className="grid gap-8 md:grid-cols-2">
                            ...
                            <div className={`flex items-start gap-4 rounded-lg bg-white bg-opacity-90 p-6 shadow-lg ring-1 ring-white/[0.05]  transition transform hover:scale-105`}>
                                <div className={`flex size-12 shrink-0 items-center justify-center rounded-full bg-${primaryColor}/10 sm:size-16`}>
                                    <FontAwesomeIcon icon={faHandHoldingUsd} className={`text-${primaryColor} size-5 sm:size-6`} />
                                </div>
                                <div className="pt-3 sm:pt-5">
                                    ...
                                    <p className="mt-4 text-sm/relaxed text-gray-700 ">
                                        Mikopo ni Ajira, ni Njia ya Maendeleo. Imfaidishe Mkopaji.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className={`flex items-start gap-4 rounded-lg bg-white bg-opacity-90 p-6 shadow-lg ring-1 ring-white/[0.05]  transition transform hover:scale-105`}>
                                <div className={`flex size-12 shrink-0 items-center justify-center rounded-full bg-${primaryColor}/10 sm:size-16`}>
                                    <FontAwesomeIcon icon={faUsers} className={`text-${primaryColor} size-5 sm:size-6`} />
                                </div>
                                <div className="pt-3 sm:pt-5">
                                    <h2 className="text-xl font-semibold text-black">
                                        Ushirikiano
                                    ...
                                    <p className="mt-4 text-sm/relaxed text-gray-700">
                                        Kushirikiana huongeza ubora wa kazi na umoja.
                                        Umoja ni nguvu.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className={`flex items-start gap-4 rounded-lg bg-white bg-opacity-90 p-6 shadow-lg ring-1 ring-white/[0.05]  transition transform hover:scale-105`}>
                                <div className={`flex size-12 shrink-0 items-center justify-center rounded-full bg-${primaryColor}/10 sm:size-16`}>
                                    <FontAwesomeIcon icon={faRocket} className={`text-${primaryColor} size-5 sm:size-6`} />
                                </div>
                                <div className="pt-3 sm:pt-5">
                                    <h2 className="text-xl font-semibold text-black">
                                        Wasilisha
                                    ...
                                    <p className="mt-4 text-sm/relaxed text-gray-700">
                                        Thamani ya mkopo ni kumfikia mlengwa. Bila mlaji bidhaa haina thamani.
                                    </p>
                                </div>
                            </div>
                        </div>
