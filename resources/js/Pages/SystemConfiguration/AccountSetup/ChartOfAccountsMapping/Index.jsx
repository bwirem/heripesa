...
export default function Index({ auth, chartofaccountsmapping, chartofaccounts }) {
    ...
    chartofaccountsmapping.data.forEach(mapping => {
        if (mapping.customer_loan_code) mappedAccountIds.add(mapping.customer_loan_code.toString());
        if (mapping.customer_loan_interest_code) mappedAccountIds.add(mapping.customer_loan_interest_code.toString());
        if (mapping.customer_deposit_code) mappedAccountIds.add(mapping.customer_deposit_code.toString());
    });
