...
export default function Edit({ chartofaccountsmapping, chartofaccounts }) {
    ...
    const { data, setData, put, errors, processing, reset } = useForm({
        customer_loan_code: chartofaccountsmapping.customer_loan_code || "",
        customer_loan_interest_code: chartofaccountsmapping.customer_loan_interest_code || "",
        ...
        >
            ...
            <div className="py-12">
                <div className="mx-auto max-w-4xl sm:px-6 lg:px-8">
                    ...
                    <FlashBanner flash={flash} /> {/* ✅ Added FlashBanner here */}
