...
import {
    ...
    faClipboardList, // Physical loan (more appropriate icon)
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white shadow-md rounded-lg p-6 hover:shadow-lg transition-shadow duration-200">
                            <Link href="/loan3/normal-adjustment" className="block"> {/* Wrap with Link */}
                        ...
                        {/* Physical loan */}
                        <div className="bg-white shadow-md rounded-lg p-6 hover:shadow-lg transition-shadow duration-200">
                            <Link href="/loan3/physical-loan" className="block"> {/* Wrap with Link */}
                                <div className="flex items-center">
                                    <div className="p-3 bg-green-500 rounded-full">
                                        <FontAwesomeIcon icon={faClipboardList} className="text-white" aria-label="Physical loan" />
                                    </div>
                                    <div className="ml-4">
                                        <p className="text-gray-600">Physical Loan</p>
                                        <h3 className="text-2xl font-bold text-gray-800">{expenseItemCount}</h3> {/* Use prop */}
                                        <div className="mt-2">
                                           <span className="text-green-500">Manage Loan</span>  {/* Removed hover:underline */}
                                        </div>
                                    </div>
                                </div>
                            </Link>
